...
# This script helps set up and run the Activity Service API

set -e  # Exit on any error

echo "🏃 Activity Service Setup and Startup Script"
echo "============================================="
...
if [ ! -f ".env" ]; then
    if [ -f ".env.example" ]; then
        ...
        echo "   - COSMOS_DATABASE_NAME: Database name (default: activityservice)"
        echo "   - COSMOS_CONTAINER_NAME: Container name (default: activities)"
        echo ""
...
# Start the service
echo "🚀 Starting Activity Service API..."
